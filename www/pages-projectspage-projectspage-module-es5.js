...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-projectspage-projectspage-module"], {
  ...
  function srcAppPagesProjectspageProjectspagePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_projectstore_projectstore_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/app/services/projectstore/projectstore.service */
    "./src/app/services/projectstore/projectstore.service.ts");

    var Project = function Project(id, pend, pinfo, pname, pstart) {
    ...
    var ProjectspagePage = /*#__PURE__*/function () {
      function ProjectspagePage(routerOutlet, modalController, router, animationCtrl, projectService) {
      ...
      _createClass(ProjectspagePage, [{
        ...
        value: function ngOnInit() {
          ...
          this.projectService.read_project().subscribe(function (data) {
            _this.projectList = data.map(function (e) {
              var id = e.payload.doc.id;
              var pend = e.payload.doc.data()['pend'];
              var pinfo = e.payload.doc.data()['pinfo'];
              var pstart = e.payload.doc.data()['pstart'];
              var pname = e.payload.doc.data()['pname'];
              return new Project(id, pend, pinfo, pname, pstart);
            });

            for (var i = 0; i <= _this.projectList.length; i++) {
              _this.projectData = _this.projectList[i];
            }
                ...
                switch (_context.prev = _context.next) {
                  case 0:
                    enterAnimation = function enterAnimation(baseEl) {
                      var backdropAnimation = _this2.animationCtrl.create().addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', '0.01', 'var(--backdrop-opacity)');

                      var wrapperAnimation = _this2.animationCtrl.create().addElement(baseEl.querySelector('.modal-wrapper')).keyframes([{
                        offset: 0,
                        opacity: '0',
                        transform: 'scale(0)'
                      }, {
                      ...
                      return _this2.animationCtrl.create().addElement(baseEl).easing('ease-out').duration(500).addAnimation([backdropAnimation, wrapperAnimation]);
                    };
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["IonRouterOutlet"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AnimationController"], src_app_services_projectstore_projectstore_service__WEBPACK_IMPORTED_MODULE_6__["ProjectstoreService"]])], ProjectspagePage);
    /***/
  }
}]);
